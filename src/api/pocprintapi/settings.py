...
POC_PRINT_HUB_DEAD_QUEUE_SCHEDULE_SEC = float(os.environ.get('POC_PRINT_HUB_DEAD_QUEUE_SCHEDULE_SEC'))
POC_PRINT_HUB_DEAD_QUEUE_MAX_RETRIES = int(os.environ.get('POC_PRINT_HUB_DEAD_QUEUE_MAX_RETRIES'))
POC_PRINT_HUB_DEAD_QUEUE_RETRY_DELAY_SEC = int(os.environ.get('POC_PRINT_HUB_DEAD_QUEUE_RETRY_DELAY_SEC'))
